...
class DataTransformation:
    def __init__(self, datavalidationartifact:DataValidationArtifact,
        ...
        try:
            self.datavalidationartifact:DataValidationArtifact = datavalidationartifact
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
        It initialises a KNN Imputer with the parameters specified in the training_pipeline.py file 
