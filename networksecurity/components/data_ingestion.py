...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            logging.info(f"Total documents found in collection: {count}")
            ...
            # Replace possible "na"/None-like placeholders with np.nan
            df.replace(to_replace=["na", "null", "None", "np"], value=np.nan, inplace=True)
